...
import { migrateToLatest, defaultSaveV21 } from "../../../src/store/schema";
...
describe("migrateToLatest", () => {
    ...
    it("handles empty input with defaults", () => {
        ...
        expect(out).toEqual(defaultSaveV21());
    });
    ...
    it("migrates v18 adding hasAutoEmpty and lastSeenChangelogVersion", () => {
        const v18 = {
    ...
    it("migrates v4 preserving equipment flags, zeroing workers, adding gear defaults", () => {
        ...
        expect(out.hasMagneticSeparator).toBe(false);
        expect(out.sluiceWorkers).toBe(0);
